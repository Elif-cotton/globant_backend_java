...
public class Curso implements Serializable {
    ...
    public Curso(String nombre, DiaDeLaSemana dia, Date horaInicio, Date horaFin, Integer cupo) {
        this.nombre = nombre;
        this.dia = dia;
    ...
    public String toString() {
        return "Curso{" + "nombre=" + nombre + ", dia=" + dia + ", horaInicio=" + horaInicio + 
                ", horaFin=" + horaFin + ", cupo=" + cupo + '}';
    }
