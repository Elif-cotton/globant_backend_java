...
public class Curso {
    ...
    public Curso(String nombreCurso, double cantidadHorasPorDia, double cantidadDiasPorSemana, Turno turno, double precioPorHora) {
    ...
    public String toString() {
        return "Curso{" + "nombreCurso=" + nombreCurso + ", cantidadHorasPorDia=" +
                cantidadHorasPorDia + ", cantidadDiasPorSemana=" + cantidadDiasPorSemana +
